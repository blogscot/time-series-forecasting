...
```
Both Box-Pierce and Ljung-Box p-values are above the arbitrary threshold of 5% which means that we can reject the null hypothosis: these data are indistiguishable from white noise.

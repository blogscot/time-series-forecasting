...
RMSE      MAE       MAPE
116.6422	48.73962	14.29078 - season period = 24 * 365.25
74.38767	41.08467	11.67456 - ditto + robust = TRUE
54.86714	35.69785	10.76232 - ditto + robust = FALSE
38.08355	25.75324	7.758479 - season period = 24 * 365.25 + robust = FALSE
...
```
The sensor forecasts have a couple of major problems. Firstly, the positive trend is completely unexpected and doesn't seem reasonable given past readings, and secondly the seriously wide confidence levels. This model is not working, not working at all!
...
The Dynamic Harmonic Regression model produces forecasts that look reasonable in contrast with the STL forecasts which just looks wrong.
